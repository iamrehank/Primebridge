import { Share2, Mail, Globe, Phone } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="text-2xl font-extrabold tracking-tighter mb-6">Primebridge</div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-primary-fixed/40 text-xs">
          <p>© 2024 Primebridge Marketing Solutions LLC. All rights reserved.</p>
